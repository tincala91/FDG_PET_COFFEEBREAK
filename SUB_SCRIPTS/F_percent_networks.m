...
baseDirRender=fullfile(baseDir,'ROIs'); 
        ...
        rex_source_hypo=fullfile(dir_pat,'SPM','spmT_0001_Hypo.nii');
        rex_source_pres=fullfile(dir_pat,'SPM','spmT_0002_Pres.nii');
        rex_source_mask=fullfile(dir_pat,'SPM','mask.nii');
        rex_ROIs=fullfile(baseDirRender,'CAREN_5RSNS.nii');
        ...
        copyfile(ex_file,(fullfile (dir_pat,'SPM')));
